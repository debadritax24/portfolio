...
export const socialLinks: SocialLink[] = [
  {
    name: "GitHub",
    href: "https://github.com/debadritax24",
    icon: FaGithub,
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/debadritax24/",
    icon: FaLinkedin,
  ...
  {
    name: "Instagram",
    href: "https://instagram.com/debadritax24",
    icon: FaInstagram,
  ...
  {
    name: "Discord",
    href: "https://discord.com/channels/@debadritax24",
    icon: FaDiscord,
