    ...
    <main className="min-h-screen bg-white dark:bg-[#0e0e0e] transition-colors duration-300">
      <div className="container mx-auto px-4 sm:px-6 pt-20 pb-16">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h1
            className="dark:text-white font-bold mt-3 text-slate-900 text-xl"
          >
            Page Not Found
          </h1>

          <p
            className="dark:text-slate-300 mt-4 text-slate-600 text-sm"
          >
            The page you are looking for does not exist or was moved. Try the
            homepage or projects.
          </p>
          ...
          <div className="mt-6">
            <Link
              href="/case-studies"
              className="dark:text-slate-300 text-slate-600 text-sm underline"
            >
              Browse Case Studies
            </Link>
          </div>
