        ...
        <main className="min-h-screen bg-white dark:bg-[#0e0e0e] transition-colors duration-300">
            <div className="container mx-auto px-4 sm:px-6 pt-12 pb-6">
                <div className="max-w-2xl mx-auto">
                    ...
                    >
                        These certifications support hands-on work in software engineering, cloud, and DevOps. They complement the practical outcomes shown in <a href="/experiences" className="underline hover:no-underline">experience</a> and <a href="/projects" className="underline hover:no-underline">projects</a>.
                    </p>
                            ...
                            >
                                ...
                                <div className="relative h-40 bg-gray-50 dark:bg-[#111] border-b border-gray-100 dark:border-[#222] overflow-hidden">
                                    <div className="absolute inset-0 flex items-center justify-center text-gray-400 dark:text-gray-600">
                                        {(cert.imageUrl || (cert as any).image) && ((cert.imageUrl || (cert as any).image || "").startsWith("http") || (cert.imageUrl || (cert as any).image || "").startsWith("/")) ? (
                                            <img
                                                src={cert.imageUrl || (cert as any).image}
                                                alt={cert.title}
                                ...
                                <div className="p-4 flex flex-col flex-1">
                                    ...
                                    <div className="mt-auto flex items-center justify-between pt-3 border-t border-gray-100 dark:border-[#222]">
                                        ...
                                        <Link
                                            ...
                                            rel={cert.credentialUrl?.startsWith("http") ? "noopener noreferrer" : undefined}
