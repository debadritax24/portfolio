...
export default function SendEmailPage() {
  ...
  return (
    <main className="min-h-screen bg-white text-slate-900 dark:bg-[#0e0e0e] dark:text-slate-50">
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-4 pb-20 pt-14 sm:px-6">
          ...
          <div className="mt-10 grid gap-8 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              <h1 className="font-bold font-semibold leading-tight sm:text-4xl text-3xl">
              ...
              <div className="mt-6 rounded-2xl border border-dashed border-slate-300 bg-white/60 px-4 py-3 text-xs text-slate-500 dark:border-slate-700 dark:bg-[#0F1320]/50 dark:text-slate-400">
                Prefer a direct route? Email me at <span className="font-medium">debagoswami2006@gmail.com</span>
              </div>
            </div>
              ...
              <div className="mt-6 grid gap-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="mt-2 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 shadow-sm focus:border-slate-400 focus:outline-none focus:ring-1 focus:ring-slate-300 dark:border-slate-700 dark:bg-[#0e0e0e] dark:text-slate-100 dark:placeholder:text-slate-500 dark:focus:border-slate-500 dark:focus:ring-slate-600"
                    maxLength={80}
